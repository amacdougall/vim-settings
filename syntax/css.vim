...
hi link cssAtkeyword Constant
hi link cssAtType Identifier
hi link cssAtkey Special
hi link cssMediaProp Type
hi link cssAtProps Function

hi link cssAttr String

hi link cssAttValFn Function

hi link cssValBlock Function
hi link cssValFn Function

hi link cssAttrBlock Normal

hi link cssBraket Function
...
hi link cssPathFn Directory

hi link cssFunction Function
hi link cssFnValBlock Function

hi link cssFuncRegion Function

hi link cssIdentifier Function

hi link cssImportant PreProc

hi link cssUnits String

hi link cssNumber Number

hi link cssPrefix Special

hi link cssProp Type

hi link cssPropRegion Normal

hi link cssPseudo Structure

hi link cssQuote String

hi link cssSelector Structure
