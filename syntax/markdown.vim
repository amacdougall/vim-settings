...
" Filenames:    *.markdown
" Last Change:	2012 March 11
" Modified:     Alan MacDougall, adding Octopress {% codeblock %} escape
...
" handle Octopress plugin stuff
syn region markdownCodeBlock start="{% codeblock.\+%}" end="{% endcodeblock %}" contained
...
syn region markdownItalic start="\S\@<=_\s\@=\|\s\@<=_\S\@=" end="\S\@<=_\|_\S\@=" keepend contains=markdownLineStart
