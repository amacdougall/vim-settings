...
syn keyword sqlKeyword      exclusive exists explain external file for foreign from function
syn keyword sqlKeyword      group having identified if immediate increment index
syn keyword sqlKeyword      initial inner into is join key left level limit loop
...
hi def link sqlOperator      PreProc
hi def link sqlParen         Comment
hi def link sqlParenEmpty    Operator
hi def link sqlParenFunc     Function
