...
syn region  actionScriptDocComment                      start="/\*\*" end="\*/" contains=actionScriptCommentString,actionScriptCharacter,actionScriptNumber
...
if main_syntax == "actionscript"
  ...
  syn sync ccomment actionScriptDocComment
endif
